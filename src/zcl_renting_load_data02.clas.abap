CLASS zcl_renting_load_data02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RENTING_LOAD_DATA02 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

  DATA: lt_brands TYPE TABLE OF zrent_brands_02,
          lt_cars TYPE TABLE OF zrent_cars_02,
     lt_customers TYPE TABLE OF zrent_customer02.
...
* BRANDS **
 ...
 INSERT zrent_brands_02 FROM TABLE @lt_brands.
 SELECT * FROM zrent_brands_02 INTO TABLE
@lt_brands.
 out->write( sy-dbcnt ).
 out->write( 'zrent_brands_02 data inserted  successfully!' ).
...
fecha_fabr = '20210716' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20211201' alq_hasta = '20211206' )
 ...
 DELETE FROM zrent_cars_02.
 INSERT zrent_cars_02 FROM TABLE @lt_cars.
 SELECT * FROM zrent_cars_02 INTO TABLE @lt_cars.
 out->write( sy-dbcnt ).
 out->write( 'zrent_cars_02 data inserted  successfully!' ).


** CUSTOMERS**
 lt_customers = VALUE #( ( doc_id = '005638984K' matricula = '8764FGH' nombres = 'Olivia' apellidos = 'Allan' email = 'olivia.allan@email.com' cntr_type = 'C1' )
 ...
 ( doc_id = '345839534R' matricula = '2356FSF' nombres = 'Andrew' apellidos = 'Langdon' email = 'andrewlangdon@email.com' cntr_type = 'C2' )
 ...
 DELETE FROM zrent_customer02.
 INSERT zrent_customer02 FROM TABLE @lt_customers.
 SELECT * FROM zrent_customer02 INTO TABLE @lt_customers.
 out->write( sy-dbcnt ).
 out->write( 'zrent_customer02 data inserted successfully!').
